<main class="scrivena">
    <div class="caja_superior">
        <h1>Your financial success starts with <br>SCRIVENA</h1>
        <p>SCRIVENA: Your key ally on the path to prosperity and financial stability</p>
    </div>
    ...
    <div class="caja_section">
        <div class="carrusel">
            <div class="elemento">
                ...
                <h3 class="titulo_elemento">Your financial success starts with SCRIVENA</h3>
                <p class="texto_elemento">SCRIVENA: Your key ally on the path to prosperity and financial stability</p>
            </div>
            <div class="elemento">
                <picture>
            ...
            <div class="elemento">
                ...
                <p class="texto_elemento">Your financial success within reach: achieve your wealth goals with the support of our experts</p>
            </div>
        </div>
        <div class="carrusel-nav">
            <!-- Navigation dots generated here with JavaScript -->
        </div>
    </div>
    <div class="oportunidades">
        ...
        <div class="img_p">
            <div>
                ...
                <p>Complete our easy and secure form to open your account.</p>            </div>
            <div class="flecha">
                <picture>
            ...
            <div>
                ...
                <p>Get your profits within the agreed term.</p>
            </div>
        </div>
        <div class="nuestros_servicios">
            ...
            <div class="texto_servicios subtitulo_servicios">
                ...
                <p>SCRIVENA provides personalized financing for various projects, ranging from fiduciary solutions to environmental initiatives, focusing on sustainable growth and environmental care.</p>
            </div>
        ...
        <div class="contenedor--porque_scrivena">
            <div class="porque_scrivena">
                ...
                <p>Optimization of returns and minimization of risks tailored to individual financial goals.</p>
            </div>
            <div class="porque_scrivena">
                <picture>
                ...
                <p>Diverse investments in mining, real estate developments, mortgage auctions, and U.S. investment funds.</p>
            </div>
            <div class="porque_scrivena">
                <picture>
                ...
                <p>Offering advice and education to make informed decisions.</p>
            </div>
            <div class="porque_scrivena">
                <picture>
    ...
    <div class="contenedor--area-cliente">
        <div class="area_cliente">
            <h3>Manage your upcoming payments and investments in the client section</h3>
            <p>As a Scrivena client, you can track your investments quickly, wherever you are.</p>
        </div>
