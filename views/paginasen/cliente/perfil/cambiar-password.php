...
<p class="auth__texto">Enter your new password</p>
<div class="dashboard__contenedor--boton">
<a class="dashboard__boton" href="/client/profile?lang=en">
            ...
            <form method="POST" class="formulario formulario--olvide" novalidate>
                <div class="campo-contenedor">
                    <div class="campo_contenedor-arriba">
                        ...
                        <p class="campo-titulo">Current password</p>
                    </div>
                    <div class="campo_contenedor-abajo">
                        <div class="campo">
                            <input class="formulario__input input-password" type="password" name="password_actual" id="password_actual" placeholder="Current password">
                        </div>
                    </div>
                </div>
                <div class="campo-contenedor">
                    <div class="campo_contenedor-arriba">
                        ...
                        <p class="campo-titulo">New password</p>
                    </div>
                    <div class="campo_contenedor-abajo">
                        <div class="campo">
                            <input class="formulario__input input-password" type="password" name="password_nuevo" id="password_nuevo" placeholder="New password">
                        </div>
                    </div>
                </div>
                ...
                <div class="campo-contenedor">
                    <div class="campo_contenedor-arriba">
                        <span class="campo-orden">2.</span>
                        <p class="campo-titulo">Repeat New Password</p>
                    </div>
                    <div class="campo_contenedor-abajo">
                        <div class="campo">
                            <input class="formulario__input input-password" type="password" name="password_nuevo2" id="password_nuevo2" placeholder="Repeat New Password">
                        </div>
                    </div>
                </div>

                <div class="contenedor-boton">
                    <input class="boton boton--login" type="submit" value="Save Password">
                </div>
            </form>
